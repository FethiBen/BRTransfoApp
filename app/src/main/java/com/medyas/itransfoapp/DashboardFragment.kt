...
class DashboardFragment : Fragment() {
    ...
    inner class someTask(obj: String) : AsyncTask<Void, Void, Result<Any, FuelError>>() {
        ...
        override fun doInBackground(vararg params: Void?): Result<Any, FuelError> {
            val (request, response, result) = "https://fethiben.github.io/RB-TransfosWeb/devicesub/".httpPost().body(p).responseString()
    ...
    inner class getmsg(obj: String) : AsyncTask<Void, Void, Result<Any, FuelError>>() {
        private var p = obj
        override fun doInBackground(vararg params: Void?): Result<Any, FuelError> {
            val (request, response, result) = "https://fethiben.github.io/RB-TransfosWeb/getmessages/".httpPost().body(p).responseString()
